...
The TGT-RMBS-2025-001 pool contains 10,000 mortgages distributed across 5 UK regions.
...
**HPI Adjustment:** 1.15x (London premium)
...
**HPI Adjustment:** 0.95x (slight discount)
...
**HPI Adjustment:** 0.85x (regional discount)
...
**HPI Adjustment:** 0.80x (lower value area)
...
**HPI Adjustment:** 0.75x (lower value area)
...
**Top 5 Markets:**
1. London Central: 12% of pool
2. London North: 10% of pool
3. London South: 10% of pool
4. Greater Manchester: 3% of pool
5. Kent: 3% of pool
...
- Lower credit scores in North = higher default risk
- Lower HPI adjustments = lower loss recovery
- London concentration provides stability

---

## HPI Stress by Region

Under a 20% house price decline scenario:
...
### London (Central - GBP 473.2m)
- **Latitude:** 51.5074
- **Longitude:** -0.1278
- **Loans:** 6,450
- **Radius:** Large concentration marker

### South East (Centered on Surrey - GBP 113.7m)
- **Latitude:** 51.2500
- **Longitude:** -0.4500
- **Loans:** 1,550
- **Radius:** Medium concentration marker

### East Anglia (Centered on Norwich - GBP 58.6m)
- **Latitude:** 52.6309
- **Longitude:** 1.2974
- **Loans:** 800
- **Radius:** Small concentration marker

### Midlands (Centered on Birmingham - GBP 43.9m)
- **Latitude:** 52.5086
- **Longitude:** -1.8855
- **Loans:** 600
- **Radius:** Small concentration marker

### North (Centered on Manchester - GBP 43.6m)
- **Latitude:** 53.4808
- **Longitude:** -2.2426
- **Loans:** 600
- **Radius:** Small concentration marker
...
### London Dominance
**Why 64.5% in London?**
- Higher house prices = higher absolute loan amounts
- Better credit quality = lower default risk
- Strong HPI support = better recovery
- More stable employment = lower unemployment risk

**Implication for RMBS:**
- Provides significant stability to the pool
- Class A protection benefits from London concentration
- Economic downturn in London would impact pool significantly

### Regional Diversification
**Why other regions matter:**
- Reduces single-market risk
- Provides geographic hedging
- Captures regional economic variations
- Spreads unemployment risk

**Implication for RMBS:**
- If London struggles, other regions provide stability
- Regional economic variations create natural hedging
- Different regional cycles reduce correlation
